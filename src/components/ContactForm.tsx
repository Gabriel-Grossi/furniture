...
export function ContactForm() {
    return (
        <form action="" className="grid w-1/2 gap-y-4 max-md:w-full">
            ...
            <input type="text" name="name" id="name" className="rounded-sm border-none ring-1 ring-yellow-700 text-sm focus:ring focus:ring-offset-1 focus:ring-yellow-700" placeholder="Type your name here" required autoFocus />
